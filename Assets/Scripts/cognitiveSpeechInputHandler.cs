...
public class cognitiveSpeechInputHandler : MonoBehaviour
{
    ...
    void Start()
    {
        UnityEngine.Debug.LogError("Waiting for Recognition: " + waitingforReco.ToString() + "\n");
        UnityEngine.Debug.LogError("Mic permission granted: " + micPermissionGranted.ToString() + "\n");
